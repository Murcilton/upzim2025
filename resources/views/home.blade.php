                        ...
                        <div class="modal-dialog ">
                            <div class="modal-content editModal">
                                ...
                                <div class="modal-body">
                                    <input value="{{ $task->name }}" type="text" class="form-control inputEdit"
                                        name="name" placeholder="Название">
                                    <textarea value="{{ $task->description }}" type="text" class="form-control inputEdit descriptionEdit"
                                        name="description" placeholder="Описание">{{ $task->description }}</textarea>
                                    <select class="form-select inputEdit" name="status"
