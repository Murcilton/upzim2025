        ...
        <div class="folder-container">
                            ...
                            <div class="dropdown-button dropdown-folder-btn">
                                        ...
                                        <div class="btnContext"><i class="fa-solid fa-chevron-right"
                                            ...
                                            <form action="{{ route('destroy.folder', $folder->id) }}" method="POST"
                                                ...
                                                <button type="submit" class="contextDelete"><i
                                                        class="fa-regular fa-trash-can" style="color: #ff0000;"></i> Удалить
                                                </button>
                                            </form>
                                        </div>
                                    </div>
                                ...
                                <ul class="dropdown dropdown-folder">
                                    ...
                                    <div class="folder-add">
                                        <form action="{{ route('folder.add') }}" enctype="multipart/form-data"
                                            method="post">
                                            @csrf
                                            ...
                                            <input type="file" name="file"
                                                id="file-to-folder-input-{{ $folder->id }}"
                                                class="form-control file-to-folder-input"
                                                placeholder='Добавить файл в папку'>
                                    ...
                                    <div class="dropdown-items">
                                        ...
                                        @else
                                            @foreach ($folderFiles as $file)
                                                ...
                                                <li>
                                                    <div class="file-item menu-item"
                                                        data-menu="context-menu-{{ $file->id }}">
            ...
            @foreach ($folders as $folder)
                ...
                <form action="{{ route('folder.add') }}" enctype="multipart/form-data" method="post">
                    @csrf
                    <div class="modal fade" id="exampleModal{{ $folder->id }}" tabindex="-1"
                            ...
                            <div class="modal-content editModal addModal">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="addToFolder">
                                        <input type="file" name="file"
                                            id="file-to-folder-input-{{ $folder->id }}" class="form-control "
                                            placeholder='Добавить файл в папку'>
                                    </div>
                                </div>
                                <div class="modal-footer">
                                    <button type="submit" class="btnnav">Добавить файл <i
                    ...
                    <div class="modal fade" id="editModal{{ $folder->id }}" tabindex="-1"
                        ...
                        <div class="modal-dialog ">
                            <div class="modal-content editModal addModal">
                                <div class="modal-header">
                                    <h1 class="modal-title fs-5" id="exampleModalLabel">
                                        <i class="fa-solid fa-pen" style="color: #000000;"></i> <span
                                            class="fs-4">Переименовать папку</span>
                                    </h1>
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="addToFolder">
                                        <input type="text" name="folderName"
                                            id="file-to-folder-input-{{ $folder->id }}" class="form-control "
                                            placeholder='Название папки' value="{{ $folder->name }}">
                                    </div>
                                </div>
                                <div class="modal-footer">
                    ...
                    <div class="modal fade" id="exampleModal{{ $file->id }}" tabindex="-1"
                        ...
                        <div class="modal-dialog ">
                            <div class="modal-content editModal moveModal">
                                <div class="modal-header">
                                    <h1 class="modal-title fs-5" id="exampleModalLabel">
                                        <i class="fa-solid fa-share" style="color: #000000;"></i> <span
                                            class="fs-4">Перенос
                                            файла</span>
                                        <br>
                                        <span>"{{ $file->name }}"</span>
                                            ...
                                            <div class="form-check">
                                                <label class="form-check-label" for="folder-{{ $folder->id }}">
                                                    <input type="radio" class="form-check-input"
                                                        id="folder-{{ $folder->id }}" name="folderId"
                        ...
                        <div class="modal-dialog ">
                            <div class="modal-content editModal addModal">
                                <div class="modal-header">
                                    <h1 class="modal-title fs-5" id="exampleModalLabel">
                                        <i class="fa-solid fa-pen" style="color: #000000;"></i> <span
                                            class="fs-4">Переименовать файл</span>
                                    </h1>
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="addToFolder">
                                        <input type="text" name="fileName"
                                            id="file-to-folder-input-{{ $file->id }}" class="form-control "
                                            placeholder='Название файла' value="{{ pathinfo($file->name, PATHINFO_FILENAME) }}">
                                    </div>
                                </div>
                                <div class="modal-footer">
                                    <button type="submit" class="btnnav">Подтвердить <i class="fa-solid fa-circle-check"
                                ...
                                <div class="file-item menu-item" data-menu="context-menu-{{ $file->id }}">
                                    ...
                                    <div class="file-actions">
                                        <form action="{{ route('destroy.file', $file->id) }}" method="POST"
                                            ...
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" class="btnnav"><i
